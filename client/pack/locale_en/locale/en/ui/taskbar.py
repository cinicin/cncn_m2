			...
			(
				{
					...
					"images" :
					(
						"locale/en/ui/Mall/00.sub",
						"locale/en/ui/Mall/01.sub",
						"locale/en/ui/Mall/02.sub",
						"locale/en/ui/Mall/03.sub",
						"locale/en/ui/Mall/04.sub",
						"locale/en/ui/Mall/05.sub",
						"locale/en/ui/Mall/06.sub",
						"locale/en/ui/Mall/07.sub",
						"locale/en/ui/Mall/08.sub",
						"locale/en/ui/Mall/09.sub",
						"locale/en/ui/Mall/11.sub",
						"locale/en/ui/Mall/12.sub",
						"locale/en/ui/Mall/13.sub",
						"locale/en/ui/Mall/14.sub",
						"locale/en/ui/Mall/15.sub",
						"locale/en/ui/Mall/16.sub",
					)
				},
				{
					"name" : "RampageGauge2",
